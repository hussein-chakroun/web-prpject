    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- New Category Image -->
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Update Category Image</label>
                    <input type="file" 
                           name="image" 
                           id="image" 
                           accept="image/*"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" 
                              id="description" 
                              rows="4"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-gray-500">{{ $category->description }}</textarea>
                </div>
