...
<div class="space-y-6">
    ...
    <!-- Total Items and Search -->
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <span class="text-gray-600">Total Products: {{ $totalProducts }}</span>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody id="productTable" class="bg-white divide-y divide-gray-200">
                    ...
                    <tr id="product-row-{{ $product->id }}" class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {{ $categoryMap[$product->category_id] ?? 'N/A' }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            ...
                            <form method="POST" action="" id="delete-form-{{ $product->id }}" class="hidden">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
